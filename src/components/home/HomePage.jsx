...
import HeroBanner from '@/components/home/HeroBanner'; // Import the HeroBanner component
  ...
  <div className="bg-[#8B5E3C] shadow-lg p-6 rounded-md">
    ...
    <p className="text-white">Only the best products curated for your needs.</p>
      ...
      {/* <section className="py-12 px-6 text-center">
        <h2 className="text-3xl  text-[#8B5E3C] font-bold mb-4">About YourStore</h2>
        <p className="max-w-2xl text-[#8B5E3C] mx-auto text-lg">
